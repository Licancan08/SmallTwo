...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            //倒计时==0时
                if(what==0)
                {
                    iv_login_yanzhengma.setImageResource(R.mipmap.getagain);//重新获取验证码
    ...
    private void initView() {
        ...
        showmima.setImageResource(R.mipmap.hidemima);//默认展示显示密码图片
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            ...
            case R.id.showmima:
                ...
                {
                    //隐藏密码
                    showmima.setImageResource(R.mipmap.hidemima);
                    et_login_pwd2.setTransformationMethod(PasswordTransformationMethod.getInstance());
                }
                else if(mima%2==1){
                    //显示密码
                    showmima.setImageResource(R.mipmap.showmima);
